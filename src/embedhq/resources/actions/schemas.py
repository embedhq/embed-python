...
from ...types.actions import schema_list_params, schema_retrieve_params
from ...types.actions.action_schema import ActionSchema
from ...types.actions.schema_list_response import SchemaListResponse
...
class SchemasResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        Args:
          integration_id: The ID of the integration to which the action schemas belong.
