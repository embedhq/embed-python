...
def _get_open_connections(client: Embed | AsyncEmbed) -> int:
...
class TestEmbed:
    ...
    def test_multipart_repeating_array(self, client: Embed) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Embed) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Embed) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Embed) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
...
class TestAsyncEmbed:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncEmbed) -> None:
    ...
    def test_base_url_trailing_slash(self, client: AsyncEmbed) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncEmbed) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncEmbed) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
