...
class TestSchemas:
    ...
    def test_method_retrieve(self, client: Embed) -> None:
        schema = client.collections.schemas.retrieve(
            "issues",
            integration_id="github-123",
        )
        assert_matches_type(CollectionSchema, schema, path=["response"])

    @parametrize
    def test_raw_response_retrieve(self, client: Embed) -> None:
        response = client.collections.schemas.with_raw_response.retrieve(
            "issues",
            integration_id="github-123",
        )
    ...
    def test_streaming_response_retrieve(self, client: Embed) -> None:
        with client.collections.schemas.with_streaming_response.retrieve(
            "issues",
            integration_id="github-123",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Embed) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `collection_key` but received ''"):
            client.collections.schemas.with_raw_response.retrieve(
                "",
                integration_id="github-123",
            )
    ...
    def test_method_list(self, client: Embed) -> None:
        schema = client.collections.schemas.list(
            integration_id="github-123",
        )
    ...
    def test_raw_response_list(self, client: Embed) -> None:
        response = client.collections.schemas.with_raw_response.list(
            integration_id="github-123",
        )
    ...
    def test_streaming_response_list(self, client: Embed) -> None:
        with client.collections.schemas.with_streaming_response.list(
            integration_id="github-123",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSchemas:
    ...
    async def test_method_retrieve(self, async_client: AsyncEmbed) -> None:
        schema = await async_client.collections.schemas.retrieve(
            "issues",
            integration_id="github-123",
        )
        assert_matches_type(CollectionSchema, schema, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEmbed) -> None:
        response = await async_client.collections.schemas.with_raw_response.retrieve(
            "issues",
            integration_id="github-123",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEmbed) -> None:
        async with async_client.collections.schemas.with_streaming_response.retrieve(
            "issues",
            integration_id="github-123",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncEmbed) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `collection_key` but received ''"):
            await async_client.collections.schemas.with_raw_response.retrieve(
                "",
                integration_id="github-123",
            )
    ...
    async def test_method_list(self, async_client: AsyncEmbed) -> None:
        schema = await async_client.collections.schemas.list(
            integration_id="github-123",
        )
        assert_matches_type(SchemaListResponse, schema, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEmbed) -> None:
        response = await async_client.collections.schemas.with_raw_response.list(
            integration_id="github-123",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncEmbed) -> None:
        async with async_client.collections.schemas.with_streaming_response.list(
            integration_id="github-123",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
